...
?>	
        ...
        <div class="body  mt-5 mb-5">
            <div class="title-intro text-dark text-center">
              <h2 class="title">MONA MEDIA</h2>
            </div>
            <div class="benner mt-5">
              <img src="images/intro/benner.jpg" alt="">
            </div>
            <div class="container-fluid mt-5 main">
              <div class="row">
                <div class="col-sm-4 text-dark text-center">
                  <h2>Mona shop</h2>
                  <div class="content">
                      <p>Bạn là người yêu quý động vật,hãy đến Mona shop nơi cung cấp các loại thú nuôi.Với đa dạng vật nuôi rất mong các bạn ghé thăm và tìm kiếm được con vật bạn yêu thích, rất mong được phục vụ quý khách. </p>
                  </div>
                  <div class="click">
                ...
                <div class="col-sm-4 text-dark text-center">
                  <h2>Mona shop</h2>
                  <div class="content"><p>Dịch vụ chăm sóc  thú nuôi với tác phong chuyên nghiệp các bạn hoàn toàn có thể yên tâm khi giao vật nuôi của các bạn cho chúng tôi. Chúng tôi rất mong được phục vụ quý khách.
                    </p>
                  </div>
                  <div class="click">
                    <button>CLICK ME</button>
                ...
                <div class="col-sm-4 text-dark text-center">
                  <h2>Mona shop</h2>
                  <div class="content">
                    <p>Dịch vụ chăm sóc  thú nuôi với tác phong chuyên nghiệp các bạn hoàn toàn có thể yên tâm khi giao vật nuôi của các bạn cho chúng tôi.Chúng tôi rất mong được phục vụ quý khách.
                    </p>
                    </div>
                  <div class="click">
                    <button>CLICK ME</button>
