            ...
            <div class="main-right">
              <div class="list-customer">
                <div class="container p-3 ms-5">
                  <h4 class="text-dark text-center">Thêm địa chỉ mới || <a href="index1.php">Quay lại</a></h4>
                  <br>
                  <form action="" method="post" class="form-info text-dark me-5">
                    <table>
                        ...
                        <tr>
                          ...
                          <td><input type="text" name="txtSdt" id="" placeholder="Email"></td>
                      </tr>
                      <tr>
                        <td><label for="pass" class="">Địa chỉ giao hàng</label></td>
                        <td><input type="text" name="txtDiachi" id="" placeholder="Mật khẩu"></td>
                    </tr>
                        <tr>
                            <td colspan="2" >
