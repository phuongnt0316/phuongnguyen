                ...
                <div class="container p-3 ms-5">
                 ...
                 if(isset($_POST["btnThem"])){
                     ...
                     if($check_id>0){
                      ...
                      $insert=$get_data->insert_meo($_POST['txtId'],$_POST['txtTen'],$maloai,$_POST['txtTenchungloai'],$_POST['txtDongia'],$_POST['txtKieulong'],$_POST['txtMausac'],$_POST['txtDorunglong'],$_POST['txtVengoai'],$_POST['txtPhobien'],$_POST['txtMota'],$_FILES['txtFile1']['name'],$_FILES['txtFile2']['name'],$trangthai);
