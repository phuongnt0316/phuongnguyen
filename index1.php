        ...
        <div id="body" class="mt-5">
            <div class="product cat container-fluid mt-5">
                ...
                <div class="menu-product d-flex flex-wrap justify-content-around">
                    ...
                    <div class="item-product text-center mb-5">
                        <a href="product-item.php?id=<?php echo $se_dog['id_dv'];?>&maloai=<?php echo $se_dog['Maloai']?>"
                            class="more" style={text-decoration:none;color:black;}>
            ...
            <div class="product cat container-fluid mt-5">
                ...
                <div class="menu-product d-flex flex-wrap justify-content-around">
                    <?php
                        ...
                        ?>
                    <div class="item-product text-center mb-5">
                        <a href="product-item.php?id=<?php echo $se_cat['id_dv'];?> &maloai=<?php echo $se_cat['Maloai'];?>"
                            class="more">
                            <div class="images-item">
            ...
            <div class="product cat container-fluid mt-5">
                ...
                foreach($get_pk as $pk){
                 ...
                 ?>
                    <div class="item-product text-center mb-5">
                        <a href="product-item.php?id=<?php echo $pk['id_sp'];?> &maloai=<?php echo $pk['Maloaisanpham'];?>"
                            class="more">
                            <div class="images-item">
